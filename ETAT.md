...
- **Alignement app ↔ mémoire final** (soutenance J-1, après lecture du mémoire `test_2.docx`) :
  ...
  - **#3 — objectif 25 m³/POSTE (NON FAIT, en attente)** : le mémoire dit explicitement objectif = **25 m³/poste** (confirmé 2× par le chef ; production 14,55 = 58 %). L'app est encore à `objectif_m3=12,5`/poste → **contradiction ouverte** avec le mémoire. À trancher : passer `objectif_m3` à 25 (attention : cascade sur l'atteinte).
